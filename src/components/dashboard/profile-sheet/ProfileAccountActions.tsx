...
export function ProfileAccountActions(): React.JSX.Element {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-zinc-200/80 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/30 p-4 space-y-3">
        ...
        <p className="text-[10px] text-zinc-500 dark:text-zinc-400">{PROFILE_COPY.signOutHint}</p>
        <button
          type="button"
        ...
        >
          ...
          {loading ? PROFILE_COPY.signingOut : PROFILE_COPY.signOut}
        </button>
      </div>
    </div>
  );
