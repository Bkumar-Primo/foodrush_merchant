      ...
      <div className="w-full max-w-[420px] bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-800 p-5 space-y-5 animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="relative">
          <input
            ...
            className="w-full rounded-lg border border-zinc-250 dark:border-zinc-750 bg-white dark:bg-zinc-950 px-3 py-2.5 text-xs text-zinc-800 dark:text-zinc-200 placeholder:text-zinc-400 focus:outline-none focus:ring-1 focus:ring-indigo-500 transition-all pr-12"
          />
