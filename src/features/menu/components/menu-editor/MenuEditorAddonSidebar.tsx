    ...
    <div className="w-[38%] border-r border-zinc-150 dark:border-zinc-950 bg-white flex flex-col h-full overflow-hidden shrink-0">
      <div className="bg-[#F5FBFC] px-4 py-3 border-b border-zinc-150 dark:border-zinc-950 flex justify-between items-center shrink-0">
        ...
        <button
          ...
          className={cn(
            "text-[10px] font-medium hover:underline flex items-center gap-0.5 shrink-0",
            tokens.colors.brand,
          )}
        >
      ...
      <div className="p-3 border-b border-zinc-100 bg-white space-y-2.5 shrink-0">
        <div className="flex items-center justify-between gap-2">
          ...
          <button
            ...
            className={cn("text-[10px] font-medium hover:underline shrink-0", tokens.colors.brand)}
          >
            + Create New Group
          </button>
        </div>
    ...
    >
      <div className="flex items-start gap-2.5 min-w-0 text-left">
        ...
        <div className="min-w-0">
          <span className="text-xs font-medium text-zinc-800 block truncate">{group.name}</span>
      ...
      <button
        type="button"
        onClick={onCustomize}
        className="text-[10px] font-medium text-zinc-800 hover:text-primary shrink-0"
      >
        Customize
      </button>
    </div>
