...
export const AUTH_PAGE_BG = BRAND_COLORS.background;

export const AUTH_CARD_CLASS =
  "w-full max-w-[420px] shrink-0 rounded-[32px] bg-white px-8 py-8 shadow-[0_20px_50px_rgba(15,23,42,0.07)]";

export const AUTH_SPLIT_MAIN_CLASS =
