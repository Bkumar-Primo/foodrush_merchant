        ...
        <div className="p-5 space-y-4">
          ...
          <div className="flex items-center w-full border border-zinc-250 dark:border-zinc-750 rounded-lg overflow-hidden h-9">
            <button
              ...
              className="flex items-center justify-center hover:bg-zinc-50 dark:hover:bg-zinc-800 h-full w-14 text-base font-bold text-zinc-555 border-r border-zinc-200 dark:border-zinc-750 cursor-pointer transition-colors disabled:opacity-50"
            >
              -
            </button>
            <div className="flex-1 text-xs font-black text-zinc-800 dark:text-zinc-200 h-full flex items-center justify-center bg-white dark:bg-zinc-900">
              {extraTime} mins
            </div>
            <button
              onClick={incrementTime}
              disabled={isSubmitting}
              className="flex items-center justify-center hover:bg-zinc-50 dark:hover:bg-zinc-800 h-full w-14 text-base font-bold text-zinc-555 border-l border-zinc-200 dark:border-zinc-750 cursor-pointer transition-colors disabled:opacity-50"
            >
              +
            </button>
          </div>
          ...
          <button
            ...
            disabled={isSubmitting}
            className="w-full h-10 bg-[#249B5E] hover:bg-[#1E8650] text-white rounded-md py-2.5 text-xs font-black transition-all cursor-pointer text-center disabled:opacity-50 active:scale-[0.99] flex items-center justify-center"
          >
            {isSubmitting ? (
