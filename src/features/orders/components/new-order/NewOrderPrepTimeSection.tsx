    ...
    <div className="px-4 py-3 space-y-2.5 bg-white dark:bg-zinc-900">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-1.5">
          <button
            type="button"
            className="inline-flex items-center gap-1 border border-blue-200 hover:bg-blue-50 text-blue-600 dark:border-blue-900/80 dark:hover:bg-blue-950/20 dark:text-blue-400 px-2 py-0.5 rounded text-[9.5px] font-bold cursor-pointer transition-colors"
          >
