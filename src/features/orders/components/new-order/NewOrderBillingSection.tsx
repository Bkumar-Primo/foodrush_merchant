    ...
    <>
      ...
      <div className="px-4 py-2.5 flex justify-between items-center bg-[#F9FAFB] dark:bg-zinc-900/50">
        <div className="flex items-center gap-1.5">
          <span className="text-xs font-medium text-zinc-800 dark:text-zinc-200">Total Bill</span>
          <span className="bg-emerald-50 text-emerald-700 border border-emerald-250/50 dark:bg-emerald-950/30 dark:text-emerald-400 dark:border-emerald-900/50 px-1.5 py-0.5 rounded text-[8px] font-medium uppercase tracking-wider">
            PAID
          </span>
        </div>
